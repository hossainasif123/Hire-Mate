...
class HireRequest(models.Model):
    sender = models.ForeignKey(
        Profile, on_delete=models.SET_NULL, null=True, blank=True, related_name="sent_hire_requests")
    recipient = models.ForeignKey(
        Profile, on_delete=models.SET_NULL, null=True, blank=True, related_name="received_hire_requests")
    ...
    def __str__(self):
        return f"Hire request from {self.sender} to {self.recipient}"
